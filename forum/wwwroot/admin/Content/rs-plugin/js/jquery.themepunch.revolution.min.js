...
(function (e, t) {
    ...
    function r(t, n) {
        try {
            if (n.hideThumbsUnderResoluition != 0 && n.navigationType == "thumb") {
                if (n.hideThumbsUnderResoluition > e(window).width()) e(".tp-bullets").css({display: "none"}); else e(".tp-bullets").css({display: "block"})
            }
        } catch (r) {
        }
    ...
    function b(n, r) {
        r.container.parent().find(".tp-fullwidth-forcer").css({height: r.container.height()});
    ...
    function N(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            var F = 0;
            var I = 0;
            if (l == 12) F = P; else if (l == 15) F = 0 - P; else if (l == 13) I = B; else if (l == 14) I = 0 - B;
            var q = 1;
            var R = 1;
            var U = 1;
            ...
            if (d == 6) U = .6;
            TweenLite.fromTo(j, X, {left: F, top: I, scale: U, opacity: q, rotation: r.rotate}, {
                opacity: 1,
                rotation: 0,
                left: 0,
                top: 0,
    ...
    function k(t) {
        ...
        if (t.data == YT.PlayerState.PLAYING) {
            ...
            var s = i.data("opt");
            if (t.data != -1) {
                if (s.conthover == 0) i.animate({width: "100%"}, {
    ...
    function M(n, r, i) {
        ...
        n.find(".tp-caption").each(function (n) {
            ...
            if (l == 0) {
                ...
                var I = 0, q = j, R = F, U = 2, z = 1, W = 0, X = 1, V = 1, $ = 1, J = 0, K = 0, Q = 0, G = 0, Y = 0,
                    Z = 0, et = 0, tt = "center,center", nt = 300, rt = 0, it = false, st = 0;
    ...
    function B(n, r, i) {
        ...
        if (n.hasClass("ltr") || n.hasClass("ltl") || n.hasClass("str") || n.hasClass("stl") || n.hasClass("ltt") || n.hasClass("ltb") || n.hasClass("stt") || n.hasClass("stb") || n.hasClass("skewtoright") || n.hasClass("skewtorightshort") || n.hasClass("skewtoleft") || n.hasClass("skewtoleftshort")) {
            ...
            if (n.hasClass("ltr") || n.hasClass("skewtoright")) u = r.width + 60; else if (n.hasClass("ltl") || n.hasClass("skewtoleft")) u = 0 - n.width() - 60; else if (n.hasClass("ltt")) a = 0 - n.height() - 60; else if (n.hasClass("ltb")) a = r.height + 60; else if (n.hasClass("str") || n.hasClass("skewtorightshort")) {
                u = u + 50;
                oo = 0
        ...
        revolution: function (i) {
            ...
            return this.each(function () {
                ...
                if (o.forceFullWidth == "on") {
                    ...
                    u.parent().css({width: e(window).width()});
                    u.css({left: 0 - a + "px", position: "absolute", width: e(window).width()});
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    var c = e.fn.jquery.split("."), h = parseFloat(c[0]), y = parseFloat(c[1]),
                        b = parseFloat(c[2] || "0");
                    if (h == 1 && y < 7) {
                    ...
                    e(window).resize(function () {
                        if (e("body").find(u) != 0) if (o.forceFullWidth == "on") {
                            ...
                            o.container.parent().css({width: e(window).width()});
                            o.container.css({left: 0 - t + "px", width: e(window).width()})
                        }
